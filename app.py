...
#
#         # Generate PDF report
#         pdf_file = generate_pdf(age, glucose, blood_pressure, result_text)
#
#         return render_template('result.html', result=result_text, report_file=pdf_file)
#
#     except Exception as e:
#         return f"Error: {str(e)}"
#
#
# def generate_pdf(age, glucose, blood_pressure, prediction):
#     pdf = FPDF()
#     pdf.add_page()
...
#     pdf.cell(0, 10, f"Blood Pressure: {blood_pressure}", ln=True)
#     pdf.ln(10)
#
#     # Prediction result
...
#             as_attachment=True,
#             download_name=f"disease_report_{datetime.now().strftime('%Y%m%d')}.pdf"
#         )
#     except Exception as e:
